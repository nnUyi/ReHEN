...
parser.add_argument('--channel_dim', type=int, default=24, help='numbers of feature maps')
...
parser.add_argument('--iterations', type=int, default=60000, help='training iterations')
